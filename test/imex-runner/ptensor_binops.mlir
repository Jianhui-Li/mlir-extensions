...
func.func @test_add_f64(%a : !ptensor.ptensor<?xf64>, %b : !ptensor.ptensor<?xf64>) {
    ...
    %1 = builtin.unrealized_conversion_cast %0 : !ptensor.ptensor<?xf64> to memref<?xf64>
    %2 = bufferization.to_tensor %1 : memref<?xf64>
    %3 = tensor.cast %2 : tensor<?xf64> to tensor<*xf64>
    call @printMemrefF64(%3) : (tensor<*xf64>) -> ()
...
func.func @test_floordivide_i64(%a : !ptensor.ptensor<?xi64>, %b : !ptensor.ptensor<?xi64>) {
    ...
    %1 = builtin.unrealized_conversion_cast %0 : !ptensor.ptensor<?xi64> to memref<?xi64>
    %2 = bufferization.to_tensor %1 : memref<?xi64>
...
func.func @test_logical_and_i1(%a : !ptensor.ptensor<?xi1>, %b : !ptensor.ptensor<?xi1>) {
    ...
    %1 = builtin.unrealized_conversion_cast %0 : !ptensor.ptensor<?xi1> to memref<?xi1>
    %2 = bufferization.to_tensor %1 : memref<?xi1>
    %3 = "tosa.cast" (%2) : (tensor<?xi1>) -> tensor<?xi64>
    %4 = tensor.cast %3 : tensor<?xi64> to tensor<*xi64>
