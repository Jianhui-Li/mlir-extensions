...
module {
    ...
    func.func @main() {
        ...
        %4 = builtin.unrealized_conversion_cast %3 : !ptensor.ptensor<?xi64> to memref<?xi64>
        ...
        %21 = builtin.unrealized_conversion_cast %20 : !ptensor.ptensor<?xi64> to memref<?xi64>
        ...
        %44 = builtin.unrealized_conversion_cast %42 : !ptensor.ptensor<?x?x?xi64> to memref<?x?x?xi64>
        ...
        %54 = builtin.unrealized_conversion_cast %50 : !ptensor.ptensor<i64> to memref<i64>
