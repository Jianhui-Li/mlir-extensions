// RUN: %python_executable %imex_runner -i %s   =%p/ptensor.pp -e main -entry-point-result=void mlir_ru %mlir_c_runner_utils --shared-libs=%mlir_runner_utils | FileCheck %s
