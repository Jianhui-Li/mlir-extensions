...
module attributes {torch.debug_module_name = "GELU"} {
  memref.global "private" constant @__constant_512x1280x20x15xf16 : memref<512x1280x20x15xf16> = dense<1.299800e+00>
  func.func @forward(%arg0: tensor<512x1280x20x15xf16>) -> tensor<512x1280x20x15xf16> {
    ...
    return %1 : tensor<512x1280x20x15xf16>
  }
  func.func @main() {
    %0 = memref.get_global @__constant_512x1280x20x15xf16 : memref<512x1280x20x15xf16>
    %1 = call @forward(%0) : (memref<512x1280x20x15xf16>) -> memref<512x1280x20x15xf16>
     return
  }
}
