...
module attributes {torch.debug_module_name = "ReLU"} {
  func.func @forward(%arg0: tensor<512x128x28x28xf16>) -> tensor<512x128x28x28xf16> {
    ...
    return %1 : tensor<512x128x28x28xf16>
  }
  func.func @main() {
    %0= arith.constant dense<1.3>:tensor<512x128x28x28xf16>
    %1 = call @forward(%0) : (tensor<512x128x28x28xf16>) -> tensor<512x128x28x28xf16>
     return
  }
}
