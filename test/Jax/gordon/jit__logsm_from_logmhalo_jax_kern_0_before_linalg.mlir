...
module @jit__logsm_from_logmhalo_jax_kern.0 {
  ...
  func.func private @callee(%arg0: tensor<500xf32>, %arg1: tensor<5xf32>) -> tensor<500xf32> {
    %0 = tensor.subview %arg1[0] [1] [1] : tensor<5xf32> to tensor<1xf32>
    %1 = tensor.collapse_shape %0 [] : tensor<1xf32> into tensor<f32>
    %2 = tensor.subview %arg1[1] [1] [1] : tensor<5xf32> to tensor<1xf32>
    ...
    %8 = tensor.subview %arg1[3] [1] [1] : tensor<5xf32> to tensor<1xf32>
    ...
    %12 = tensor.subview %arg1[4] [1] [1] : tensor<5xf32> to tensor<1xf32>
    ...
    %18 = tensor.subview %arg1[2] [1] [1] : tensor<5xf32> to tensor<1xf32>
